...
import jp.openstandia.connector.github.testutil.AbstractTest;
...
class SchemaTest extends AbstractTest {
    ...
    void schema() {
        ...
        Optional<ObjectClassInfo> team = schema.getObjectClassInfo().stream().filter(o -> o.is("team")).findFirst();
